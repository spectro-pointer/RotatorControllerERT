...
#define AZM_MAX_SPEED 100000 // In steps per second 75000
#define ELV_MAX_SPEED 100000 // In steps per second 100000

#define AZM_MAX_ACCEL 75000 // In steps per second per second 25000 
